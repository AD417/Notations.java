...
import io.github.ad417.Notations.BracketsNotation;
...
public class BracketsTest {
    public static Notation notation = new BracketsNotation();
    ...
    public void testNotationName() {
        assertEquals("Brackets", BracketsNotation.name);
    }
    ...
    public void test1000() {
        ...
        assertEquals("e].})", notation.format(thousand, 0, 0, 0));
        assertEquals("e].})", notation.format(thousand, 2, 0, 0));
        assertEquals("e].})", notation.format(thousand.add(6), 2, 0, 0));
    }
    ...
    public void testLargeWithCommas() {
        ...
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 0));
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 1));
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 2));
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 3));
    }
    ...
    public void testLargeWithoutCommas() {
        ...
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 2));
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 3));
        assertEquals("e[))}{{{}}}}[.({", notation.format(randomBigNum, 4));
    }
