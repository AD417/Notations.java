...
import io.github.ad417.Notations.InfinityNotation;
...
public class InfinityTest {
    public static Notation notation = new InfinityNotation();
    ...
    public void testNotationName() {
        assertEquals("Infinity", InfinityNotation.name);
    }
    ...
    public void test1000() {
        ...
        assertEquals("0.0097∞", notation.format(thousand, 0, 0, 0));
        assertEquals("0.0097∞", notation.format(thousand, 2, 0, 0));
        assertEquals("0.0097∞", notation.format(thousand.add(6), 2, 0, 0));
    }
    ...
    public void testLargeWithCommas() {
        ...
        assertEquals("938,744.389∞", notation.format(randomBigNum, 0));
        assertEquals("938,744.389∞", notation.format(randomBigNum, 3));
        assertEquals("938,744.3888∞", notation.format(randomBigNum, 4));
        assertEquals("938,744.38880∞", notation.format(randomBigNum, 5));
    }
    ...
    public void testLargeWithoutCommas() {
        ...
        BigDouble randomBigNum = new BigDouble("3.5826347327e289372384");
        assertEquals("938744.389∞", notation.format(randomBigNum, 0));
        assertEquals("938744.389∞", notation.format(randomBigNum, 3));
        assertEquals("938744.3888∞", notation.format(randomBigNum, 4));
        assertEquals("938744.38880∞", notation.format(randomBigNum, 5));
    }
